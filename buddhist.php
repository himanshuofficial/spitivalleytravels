<?php include('header.php');?>
	  ...
	  <div class="mainheading">
        <h1 class="text-center">BUDDHIST AND TRIBAL CIRCUIT–SPITI</h1>
		</div>
		<div class="row">
		
		<div class="col-sm-6">
				<div class="myimage">
				<img loading='lazy' src="images\packages\lehladakh3.webp">
				</div>
		</div>
...
<div class="myclass"> 
	<div class="myheading">
				<h5 class="colorb" >BUDDHIST AND TRIBAL CIRCUIT–SPITI</h5>		
				<h5>10 Nights and 11 Days</h5>
				<h5> INR <span class="myline"> 32,200  </span> &nbsp 19, 300  Onwards <span class="colorr">(40% off)</span> </h5>
				</div>       
<h2>Package Inclusions:</h2>		
<p>•	Welcome drink on arrival.</p>
<p>•	Pick up from Shimla and drop to Manali. </p>
<p>•	All Sightseeing as per itinerary by Innova/Tempo Traveller. </p>
<p>•	10 Nights accommodation on double sharing basis.</p>
<p>•	10 breakfasts & 10 dinners in the hotel.</p>
...
<p>On arrival at Shimla Bus station/Airport/Railway Station you will be met, assisted and drive and transfers to Hotel. Dinner and overnight stay in Shimla hotel.
</p>
<h4>
Day 02 :-Shimla to Sarahan (160Kms 05 Hrs)
</h4>
<p>
Today morning after Breakfast, drive from Shimla to Sarahan via Kufri, Theog, Fagu, Narkanda and Rampur. Take Lunch en-route in Rampur. Arrive Sarahan & check-in to your Hotel. Sarahan commands a view of Srikhand Mahadev Peak & is famous for 800 years old Bhimkali Temple, one of the best example of Hill Architecture. Enjoy panoramic view of Shrikhand Peaks in evening. After getting fresh visit to Bhimkali Temple – One of the 51 Shakti Peeth. Attain evening Aarti Ceremony. Dinner & Overnight stay at the Sarahan hotel.
</p>
<h4>
...
<p>
Have an early breakfast and head to Mudh this day. Enroute visit the Tabo Monastery which is close to 1000 years old now. The murals, thanks and paintings are believed to have been made in a single night by the Gods themselves. You can also hike to the meditation caves, if time permits.  <br>
...
<b>Tabo Monastery</b> – This Monastery is close to 1000 years old now. The murals, thankas and paintings are believed to have been made in a single night by the Gods themselves. You can also hike to the meditation caves. Dhankar Monastery- Seat of the King in ancient times- the most beautiful setting of a monument which hangs on a cliff and overlooks the confluence of Spiti and Pin River. Hike to Dhankar Lake, if your lungs permit. After that transfer to Kaza. Visit Kaza bazaar and Monastery. <br>
<b>Mud Village</b>
...
<p>
After breakfast check out from Home-stay/Hotel and drive to Kaza. Check in hotel and rest. After that visit Kaza Market and monastery. Dinner and overnight stay at Kaza.
</p>
...
<p>
Take the morning easy and today we head to Langza- the main area for Fossils,   <br>
...
<b>Langza</b>
To make this memorable, you can also hike from Langza to Komic- 3-4 hours. Overnight stay in Langza home stay
</p>
...
<p>
After breakfast, visit Key monastery and Kibber village.   <br>
...
<p>
After early breakfast we departure to Chandrataal. Chandrataal Lake is renowned for its stunning Himalayan beauty. The lake is accessible via a SUV (8 km drive) from a point after crossing Kunzum La pass. The accommodation here is basic and therefore one has to be adventure frame of mind before considering. After that drive to Manali. Dinner and overnight stay in Manali Hotel.
</p>
...
After breakfast check out from hotel and drive to Manali Volvo Station.
    ...
    <div class="row">
          ...
          <div class="single-package">
           ...
           <div align="center" class="package-content">
              <h5><strong><a href="women-tour.php">Spiti Valley Women Only Tour</a></strong></h5>
							...
							<div class="packselect" align="center">             
							 <a href="women-tour.php"> <button type="submit" class="btn btn-enq1 hvr-ripple-out">MORE DETAILS</button></a>
							</div>
          </div>
        </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="single-package">
          <div class="package-image"> <a href="lahul.php"><img loading="lazy" class="img-fluid" src="images\packages\lehladakh1.webp" alt="Simply Ladakh"> <span>9N/10D</span> </a> </div>
          <div align="center" class="package-content">
