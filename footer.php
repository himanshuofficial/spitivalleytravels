  ...
  <div class="row">
    <div class="col-md-3">
    <ul>
      <li class="hvr-icon-buzz-out"><a href="#" data-toggle="modal" data-target="#formModal">Best Spiti Valley Holiday Packages</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Holidays In Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Holiday Trip To Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Honeymoon Packages Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Packages To Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Tourism Of Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Traveling In Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Trip For Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Holidays Package</a></li>
    </ul>
    </div>

    <div class="col-md-3">
    <ul>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Packages For Couple</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Tourism Honeymoon Packages</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Trip Planner</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Best Spiti Valley Honeymoon Packages</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Holidays To Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Honeymoon At Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Packages In Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Package Tours For Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Tour Packages In Spiti Valley</a></li>
    </ul>
    </div>
    
    <div class="col-md-3">
    <ul>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Travel In Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Trips To Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Holiday Travels</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Package Tours</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Tour Packages For Couple</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Spiti Valley Vacations</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Best Spiti Valley Tour Packages</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Holiday To Spiti Valley</a></li>
      <li class="hvr-icon-buzz-out"><a href="#"data-toggle="modal" data-target="#formModal">Honeymoon Packages Of Spiti Valley</a></li>
    </ul>
    </div>
	...
	<h2>Contact</h2>
      ...
      <li class="hvr-icon-buzz-out">91-8353040008 </li>
      <li class="hvr-icon-buzz-out">spitivalleytravels@gmail.com</li>
...
<div class="section_mobile  hidden-lg hidden-md hidden-sm">
  <div class="inner_mobile">
      ...
      <div class="col-md-12">
	  <a class="_btn_bm" href="tel:+91-8353040008"> 
