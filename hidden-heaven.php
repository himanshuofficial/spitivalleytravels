<?php include('header.php');?>
	  ...
	  <div class="mainheading">
        <h1 class="text-center">HIDDEN HEAVEN- SPITI VALLEY </h1>
		</div>
		<div class="row">
		
		<div class="col-sm-6">
				<div class="myimage">
				<img src="images\packages\lehladakh6.webp">
				</div>
		</div>
...
<div class="myclass">  
<div class="myheading">
				<h5 class="colorb" >HIDDEN HEAVEN- SPITI VALLEY </h5>		
				<h5>08 Nights and 09 Days</h5>
				<h5> INR <span class="myline"> 28,800 </span> &nbsp 15,800    Onwards <span class="colorr">(45% off)</span> </h5>
				</div>
...
After breakfast check out from Home-stay/Hotel and drive to Kaza. Check in hotel and rest. After that visit Kaza Market and monastery. Dinner and overnight stay at Kaza.
 ...
 <h4>
 DAY 06:  Kaza - Hikkim – Komic – Langza – (70 kms/ 3 hours)
...
<h4>
DAY 07: LANGZA – KEY MONASTERY – KIBBER – Chandertaal 
...
<br>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="single-package">
            <div class="package-image"> <a href="women-tour.php"><img class="img-fluid" src="images\packages\lehladakh4.webp" alt="Ladakh by Motor Bike"> <span>9N/10D</span> </a> </div>
            <div align="center" class="package-content">
